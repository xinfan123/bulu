...
public class SendedMessageListView extends ListView implements OnScrollListener, OnItemClickListener {
	...
	public void onRefresh() {
		mhandler.postDelayed(new Runnable() {
			@Override
			public void run() {
				SendedMessageListView.this.refresh();
				onLoad();
			}
		}, 1000);
	}
	...
	public void onLoadMore() {
		mhandler.postDelayed(new Runnable() {
			@Override
			public void run() {
				SendedMessageListView.this.loadMore();
				onLoad();
			}
		}, 1000);
	}
	...
	public void refresh() {
		...
		Request request = new Request(FunIdConstants.GET_USER_SEND_MESSAGE_LIST);
		...
		AnsynHttpRequest.requestSimpleByPost(context, request, new RequestSucessCallBack() {
			...
			public void call(Request data) {
				...
				SendedMessageListView.this.ad.notifyDataSetChanged();
			}
		});
	}
