...
public class LoginActivity extends BaseActivity {
		...
		AnsynHttpRequest.requestSimpleByPost(this, request, new RequestSucessCallBack() {
			...
			public void call(Request data) {
				...
				if(result.getResult()==1){
					...
					ToastUtil.showMessage(LoginActivity.this,result.getMsg());
					
					SharePreferenceUtil util = new SharePreferenceUtil(LoginActivity.this, Constants.USER_INFO);
					...
					util.setCredit(result.getCredit());
					...
					LoginUserContext.setIsLogin(LoginActivity.this, true);
	...
	public void login_pw(View v) {
		Intent intent = new Intent();
		intent.setClass(LoginActivity.this, ForgetPasswordStep1.class);
		startActivity(intent);
		// Intent intent = new Intent();
